...
namespace FluentAutomation.Generator.SpecflowPlugin
{
    public class FluentAutomationTestGenerator : IGeneratorPlugin
    {
        ...
        private void GeneratorPluginEventsOnCustomizeDependencies(object sender,
            CustomizeDependenciesEventArgs customizeDependenciesEventArgs)
        {
            ...
            switch (unitTestProviderName)
            {
                ...
                default:
                {
                    throw new Exception(String.Format("Unknow unit test provider: {0}", unitTestProviderName));
                }
            }
